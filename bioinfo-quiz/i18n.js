...
(function(){
  ...
  const STR = {
    ...
    quizAllChapters: { zh:"生物資訊互動考題（全部章節）", en:"Bioinformatics Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"生物資訊互動考題", en:"Bioinformatics Interactive Quiz" },
